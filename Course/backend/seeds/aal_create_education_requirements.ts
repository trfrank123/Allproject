...
export async function seed(knex: Knex): Promise<void> {
    ...
    let seedXlsx = XLSX.utils.sheet_to_json(workbook.Sheets.education_requirement);
    ...
    for(let seed of seedXlsx){
        await seedRow("course_education_requirement", { "education_requirement": seed.requirement});
    }
};